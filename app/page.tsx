    ...
    <main className="bg-[#FAF9F7] text-[#2F2F2F]">
      ...
      <section className="py-24 px-6">
        <div className="max-w-6xl mx-auto grid md:grid-cols-3 gap-8">
          {[
            {
              title: "Visual Vision Boards",
              desc: "Curate images, quotes, and ideas that reflect the life you’re growing.",
            },
            {
              title: "Gentle Goal Tracking",
              desc: "Short- and long-term goals without streaks, pressure, or guilt.",
            },
            {
              title: "Progress You Can Feel",
              desc: "Watch intentions quietly bloom into meaningful momentum.",
            },
          ].map((f, i) => (
      ...
      <section className="py-24 px-6 bg-white">
        <div className="max-w-6xl mx-auto grid md:grid-cols-3 gap-12">
          {["Create your vision", "Plant your goals", "Nurture progress"].map(
            (step, i) => (
              <div key={i} className="space-y-3">
                <span className="text-sm uppercase tracking-wider text-[#8B8B8B]">
                  Step {i + 1}
                </span>
      ...
      <section className="py-24 px-6 bg-white">
        <div className="max-w-4xl mx-auto grid md:grid-cols-2 gap-8">
          <div className="rounded-2xl bg-white p-8 space-y-4 shadow-sm">
          ...
          <div className="rounded-2xl border-2 border-black p-8 space-y-4 shadow-sm">
      ...
      <section className="py-32 px-6 text-center">
        <div className="max-w-3xl mx-auto space-y-6">
          ...
          <button className="rounded-2xl px-8 py-6 text-lg bg-black text-white">
            Create Your Blooma
          </button>
        </div>
      </section>
